...
{
    class ScrollMessageBox : Form
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrollMessageBox"/> class.
        /// </summary>
        ...
        private ScrollMessageBox(string reportText)
        {
            InitializeComponent();
            txtReportContents.Text = reportText;
        }

        private ScrollMessageBox(string reportText, string reportTitle)
        {
            InitializeComponent();
            txtReportContents.Text = reportText;
        ...
        {
            new ScrollMessageBox(reportText, reportTitle).Show();
        }
        ...
        {
            new ScrollMessageBox(reportText, reportTitle).Show(owner);
        }
        ...
        {
            new ScrollMessageBox(reportText, reportTitle).ShowDialog(owner);
        }
        ...
        {
            new ScrollMessageBox(reportText).Show();
        }
        ...
        {
            new ScrollMessageBox(reportText).Show(owner);
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ScrollMessageBox));
